...
Menu* CreateMenu(GameSize gameSize)
{
    ...
    menu->menuStrings[Menu::TABLE_RECORD] = "Statistics";
...
void PrintMenu(Menu* menu)
{
    ...
    PrintBorderMenu(menu->gameSize.width, menu->gameSize.height);

    for (int i = 0; i < Menu::COUNT; ++i) {
        mvprintw
            (menu ->gameSize.height / 2.5 +i,
    ...
    const size_t y =
        menu->gameSize.height / 2.5 + menu->currentPoint;
    const size_t x =
